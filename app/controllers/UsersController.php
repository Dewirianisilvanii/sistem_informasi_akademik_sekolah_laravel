...
class UsersController extends BaseController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("name","email","email_verified_at","password","role","no_induk","id_card","remember_token","created_at","updated_at","deleted_at");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","name","email","email_verified_at","password","role","no_induk","id_card","remember_token","created_at","updated_at","deleted_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$cpassword = $postdata['confirm_password'];
			$password = $postdata['password'];
