...
class SiswaController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				siswa.id LIKE ? OR 
				siswa.no_induk LIKE ? OR 
				siswa.nis LIKE ? OR 
				siswa.nama_siswa LIKE ? OR 
				siswa.jk LIKE ? OR 
				siswa.telp LIKE ? OR 
				siswa.tmp_lahir LIKE ? OR 
				siswa.tgl_lahir LIKE ? OR 
				siswa.foto LIKE ? OR 
				siswa.kelas_id LIKE ? OR 
				siswa.created_at LIKE ? OR 
				siswa.updated_at LIKE ? OR 
				siswa.deleted_at LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("no_induk","nis","nama_siswa","jk","telp","tmp_lahir","tgl_lahir","foto","kelas_id","created_at","updated_at","deleted_at");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","no_induk","nis","nama_siswa","jk","telp","tmp_lahir","tgl_lahir","foto","kelas_id","created_at","updated_at","deleted_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'no_induk' => 'required',
