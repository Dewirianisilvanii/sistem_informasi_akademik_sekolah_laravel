...
class PengumumanController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				pengumuman.id LIKE ? OR 
				pengumuman.opsi LIKE ? OR 
				pengumuman.isi LIKE ? OR 
				pengumuman.created_at LIKE ? OR 
				pengumuman.updated_at LIKE ?
			)";
			$search_params = array(
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy("pengumuman.id", ORDER_TYPE);
		}
		if($fieldname){
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("pengumuman.id", $rec_id);; //select record based on primary key
		}
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("opsi","isi","created_at","updated_at");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","opsi","isi","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'opsi' => 'required',
	...
	function delete($rec_id = null){
		...
		$db->where("pengumuman.id", $arr_rec_id, "in");
