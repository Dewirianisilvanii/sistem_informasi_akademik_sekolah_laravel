                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-kehadiran_id"  value="<?php  echo $this->set_field_value('kehadiran_id',""); ?>" type="number" placeholder="Enter Kehadiran Id" step="1"  required="" name="kehadiran_id"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
