                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-no_induk"  value="<?php  echo $data['no_induk']; ?>" type="text" placeholder="Enter No Induk"  required="" name="no_induk"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-nama_siswa"  value="<?php  echo $data['nama_siswa']; ?>" type="text" placeholder="Enter Nama Siswa"  required="" name="nama_siswa"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
