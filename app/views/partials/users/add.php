                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-no_induk"  value="<?php  echo $this->set_field_value('no_induk',""); ?>" type="text" placeholder="Enter No Induk"  required="" name="no_induk"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-id_card"  value="<?php  echo $this->set_field_value('id_card',""); ?>" type="text" placeholder="Enter Id Card"  required="" name="id_card"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
