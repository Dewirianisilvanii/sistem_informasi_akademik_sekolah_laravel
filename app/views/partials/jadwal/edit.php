                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-hari_id"  value="<?php  echo $data['hari_id']; ?>" type="number" placeholder="Enter Hari Id" step="1"  required="" name="hari_id"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-ruang_id"  value="<?php  echo $data['ruang_id']; ?>" type="number" placeholder="Enter Ruang Id" step="1"  required="" name="ruang_id"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
